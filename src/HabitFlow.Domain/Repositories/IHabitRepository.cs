...
public interface IHabitRepository
{
    ...
    Task<IReadOnlyList<Habit>> ListAsync(Guid clientId, Guid userId, CancellationToken ct = default);
    ...
    Task<bool> UpdateAsync(Guid clientId, Guid userId, Habit habit, CancellationToken ct = default);
}
